...
/**
 * Provides the local service interface for CdsDemandGdprInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Miroslav Čermák
 * @see CdsDemandGdprInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CdsDemandGdprInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>cz.csob.ency.cds.demands.service.impl.CdsDemandGdprInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cds demand gdpr info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CdsDemandGdprInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CdsDemandGdprInfo deleteEntry(CdsDemandGdprInfo entry)
		throws PortalException;

	/**
	 * Delete entry
	 */
	public CdsDemandGdprInfo deleteEntry(long primaryKey)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CdsDemandGdprInfo getEntryFromMap(Map<String, Object> map);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CdsDemandGdprInfo getInitializedEntry() throws PortletException;
