...
/**
 * CdsDemand Search Registrar
 *
 * Registers the CdsDemand entity with Liferay's search framework.
 *
...
public class CdsDemandSearchRegistrar {

	@Activate
	protected void activate(BundleContext bundleContext) {
		_serviceRegistration = modelSearchRegistrarHelper.register(
			CdsDemand.class, bundleContext,
	...
	@Reference(target = "(indexer.class.name=cz.csob.ency.cds.demands.model.CdsDemand)")
	protected ModelIndexerWriterContributor<CdsDemand> modelIndexWriterContributor;
