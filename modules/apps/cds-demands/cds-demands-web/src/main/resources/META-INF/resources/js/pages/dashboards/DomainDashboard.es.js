...
export default function DomainDashboard(props) {
    ...
    const [serviceParams, setServiceParams] = useState({
        ...
        domainId: context?.userDomainId ? [Number(context.userDomainId)] : [],
    ...
    const [domainFilter, setDomainFilter] =
        useState(context?.userDomainId ? [Number(context.userDomainId)] : [])
    const [domains, setDomains] = useState([])

    const columns = ["typeLabel", "titledomain", "stateLabel", "spocName", "banName", "modifiedDate"];
