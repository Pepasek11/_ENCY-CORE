...
/**
 * Provides the local service interface for DelegatedRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Miroslav Čermák
 * @see DelegatedRoleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DelegatedRoleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>cz.csob.ency.delegations.service.impl.DelegatedRoleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the delegated role local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DelegatedRoleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(enabled = false)
	public DelegatedRole fetchOrCreate(
