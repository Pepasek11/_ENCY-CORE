...
/**
 * Provides the local service interface for Delegation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Miroslav Čermák
 * @see DelegationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DelegationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>cz.csob.ency.delegations.service.impl.DelegationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the delegation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DelegationLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(enabled = false)
	public Delegation createDelegation(long delegationId);
	...
	public Delegation deleteDelegation(Delegation delegation);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Delegation deleteDelegation(long delegationId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Delegation fetchDelegation(long delegationId);

	@Transactional(enabled = false)
	public Delegation fetchOrCreate(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Delegation getDelegation(long delegationId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Delegation> getDelegations(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Delegation> getDelegationsOfUser(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Delegation> getDelegationsToUser(
	...
	public Delegation updateDelegation(
			...
			long delegatedUserId, String note, ServiceContext serviceContext)
		throws PortalException;
