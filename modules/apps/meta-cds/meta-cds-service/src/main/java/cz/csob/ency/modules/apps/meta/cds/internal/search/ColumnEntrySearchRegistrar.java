...
/**
 * ColumnEntry Search Registrar
 *
 * Registers the ColumnEntry entity with Liferay's search framework.
 *
...
public class ColumnEntrySearchRegistrar {

	@Activate
	protected void activate(BundleContext bundleContext) {
		_serviceRegistration = modelSearchRegistrarHelper.register(
			ColumnEntry.class, bundleContext,
	...
	@Reference(target = "(indexer.class.name=cz.csob.ency.modules.apps.meta.cds.model.ColumnEntry)")
	protected ModelIndexerWriterContributor<ColumnEntry> modelIndexWriterContributor;
