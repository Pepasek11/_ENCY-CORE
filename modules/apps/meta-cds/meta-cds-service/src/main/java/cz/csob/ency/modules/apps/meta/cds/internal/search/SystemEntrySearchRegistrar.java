...
/**
 * SystemEntry Search Registrar
 *
 * Registers the SystemEntry entity with Liferay's search framework.
 *
...
public class SystemEntrySearchRegistrar {

	@Activate
	protected void activate(BundleContext bundleContext) {
		_serviceRegistration = modelSearchRegistrarHelper.register(
			SystemEntry.class, bundleContext,
	...
	@Reference(target = "(indexer.class.name=cz.csob.ency.modules.apps.meta.cds.model.SystemEntry)")
	protected ModelIndexerWriterContributor<SystemEntry> modelIndexWriterContributor;
