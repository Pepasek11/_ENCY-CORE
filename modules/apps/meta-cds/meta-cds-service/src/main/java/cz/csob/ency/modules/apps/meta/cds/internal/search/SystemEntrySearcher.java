...
/**
 * SystemEntry Searcher
 *
 * Sets up the searcher instance for SystemEntry.
 *
...
public class SystemEntrySearcher extends BaseSearcher {

	public static final String CLASS_NAME = SystemEntry.class.getName();

	public SystemEntrySearcher() {
