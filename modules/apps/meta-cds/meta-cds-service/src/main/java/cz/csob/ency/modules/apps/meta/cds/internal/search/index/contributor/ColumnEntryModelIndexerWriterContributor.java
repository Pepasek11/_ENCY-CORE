...
/**
 * ColumnEntry Model Indexer Writer Contributor
 *
...
public class ColumnEntryModelIndexerWriterContributor implements ModelIndexerWriterContributor<ColumnEntry> {
	...
	public void customize(BatchIndexingActionable batchIndexingActionable, ModelIndexerWriterDocumentHelper modelIndexerWriterDocumentHelper) {
		...
		batchIndexingActionable.setPerformActionMethod((ColumnEntry entry) -> {
			batchIndexingActionable.addDocuments(modelIndexerWriterDocumentHelper.getDocument(entry));
		});
	}

	@Override
	public IndexerWriterMode getIndexerWriterMode(ColumnEntry entry) {
	...
	public BatchIndexingActionable getBatchIndexingActionable() {
		return dynamicQueryBatchIndexingActionableFactory.getBatchIndexingActionable(
			_columnEntryLocalService.getIndexableActionableDynamicQuery());
	}

	@Override
	public long getCompanyId(ColumnEntry entry) {
