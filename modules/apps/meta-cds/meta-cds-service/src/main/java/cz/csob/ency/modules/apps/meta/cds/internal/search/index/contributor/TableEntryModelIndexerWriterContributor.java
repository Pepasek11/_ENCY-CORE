...
/**
 * TableEntry Model Indexer Writer Contributor
 *
...
public class TableEntryModelIndexerWriterContributor implements ModelIndexerWriterContributor<TableEntry> {
	...
	public void customize(BatchIndexingActionable batchIndexingActionable, ModelIndexerWriterDocumentHelper modelIndexerWriterDocumentHelper) {
		...
		batchIndexingActionable.setPerformActionMethod((TableEntry entry) -> {
			batchIndexingActionable.addDocuments(modelIndexerWriterDocumentHelper.getDocument(entry));
		});
	}

	@Override
	public IndexerWriterMode getIndexerWriterMode(TableEntry entry) {
	...
	public BatchIndexingActionable getBatchIndexingActionable() {
		return dynamicQueryBatchIndexingActionableFactory.getBatchIndexingActionable(
			_tableEntryLocalService.getIndexableActionableDynamicQuery());
	}

	@Override
	public long getCompanyId(TableEntry entry) {
		return entry.getCompanyId();
	}

	@Reference
	protected TableEntryLocalService _tableEntryLocalService;
