...
/**
 * TableEntry Model Visibility Contributor
 *
...
public class TableEntryModelVisibilityContributor implements ModelVisibilityContributor {

	@Override
	public boolean isVisible(long classPK, int status) {

		TableEntry entry = _tableEntryLocalService.fetchTableEntry(classPK);
