...
/**
 * ColumnEntry Portlet Resource Permission Regsitra
 *
 * @author Miroslav Čermák
 */
@Component(immediate = true, service = {})
public class ColumnEntryPortletResourcePermissionRegistrar {

	@Activate
	public void activate(BundleContext bundleContext) {
		Dictionary<String, Object> properties = new HashMapDictionary<>();

		properties.put("resource.name", ColumnEntryConstants.RESOURCE_NAME);

		_serviceRegistration = bundleContext.registerService(
			PortletResourcePermission.class,
			PortletResourcePermissionFactory.create(
				ColumnEntryConstants.RESOURCE_NAME,
