...
/**
 * Provides the base implementation for the system entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cz.csob.ency.modules.apps.meta.cds.service.impl.SystemEntryLocalServiceImpl}.
 * </p>
 *
 * @author "Miroslav Čermák"
 * @see cz.csob.ency.modules.apps.meta.cds.service.impl.SystemEntryLocalServiceImpl
 * @generated
 */
public abstract class SystemEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SystemEntryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SystemEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SystemEntryLocalServiceUtil</code>.
	 */
	...
	public SystemEntry addSystemEntry(SystemEntry systemEntry) {
		...
		return systemEntryPersistence.update(systemEntry);
	}
	...
	public SystemEntry createSystemEntry(long systemEntryId) {
		return systemEntryPersistence.create(systemEntryId);
	}
	...
	public SystemEntry deleteSystemEntry(long systemEntryId)
		...
		return systemEntryPersistence.remove(systemEntryId);
	}
	...
	public SystemEntry deleteSystemEntry(SystemEntry systemEntry) {
		return systemEntryPersistence.remove(systemEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return systemEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SystemEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return systemEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return systemEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return systemEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return systemEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SystemEntry fetchSystemEntry(long systemEntryId) {
		return systemEntryPersistence.fetchByPrimaryKey(systemEntryId);
	}
	...
	public SystemEntry fetchSystemEntryByUuidAndGroupId(
		...
		return systemEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public SystemEntry getSystemEntry(long systemEntryId)
		...
		return systemEntryPersistence.findByPrimaryKey(systemEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(systemEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SystemEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("systemEntryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SystemEntry.class);
			...
			new ActionableDynamicQuery.PerformActionMethod<SystemEntry>() {
				...
				public void performAction(SystemEntry systemEntry)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, systemEntry);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return systemEntryPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return systemEntryLocalService.deleteSystemEntry(
			(SystemEntry)persistedModel);
	}

	@Override
	public BasePersistence<SystemEntry> getBasePersistence() {
		return systemEntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return systemEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SystemEntry> getSystemEntriesByUuidAndCompanyId(
		...
		return systemEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<SystemEntry> getSystemEntriesByUuidAndCompanyId(
		...
		return systemEntryPersistence.findByUuid_C(
	...
	public SystemEntry getSystemEntryByUuidAndGroupId(String uuid, long groupId)
		...
		return systemEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<SystemEntry> getSystemEntries(int start, int end) {
		return systemEntryPersistence.findAll(start, end);
	}
	...
	public int getSystemEntriesCount() {
		return systemEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SystemEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		systemEntryLocalService = (SystemEntryLocalService)aopProxy;

		_setLocalServiceUtilService(systemEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SystemEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = systemEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SystemEntryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, systemEntryLocalService);
		}
	...
	protected SystemEntryLocalService systemEntryLocalService;
