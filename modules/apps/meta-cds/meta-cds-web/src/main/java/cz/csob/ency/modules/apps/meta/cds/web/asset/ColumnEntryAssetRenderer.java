 ...
 */
public class ColumnEntryAssetRenderer
	extends BaseJSPAssetRenderer<ColumnEntry> implements TrashRenderer {

	public ColumnEntryAssetRenderer(
		ColumnEntry entry, ResourceBundleLoader resourceBundleLoader) {
	...
	@Override
	public ColumnEntry getAssetObject() {
		return _entry;
	}
	...
	public String getJspPath(HttpServletRequest request, String template) {
		if (template.equals(TEMPLATE_ABSTRACT) ||
			...
			request.setAttribute("columnEntry", _entry);

			return "/column_entry/asset/" + template + ".jsp";
		}
...
//  //	
	...
	public String getType() {
		return ColumnEntryAssetRendererFactory.TYPE;
	}
...
/*
		...
		return getURLViewInContext(
			liferayPortletRequest, noSuchEntryRedirect, "/columnentry/crud",
...
*/
	...
	public boolean hasEditPermission(PermissionChecker permissionChecker)
		...
		return ColumnEntryEntryPermission.contains(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ColumnEntryAssetRenderer.class);

	private AssetDisplayPageFriendlyURLProvider
		_assetDisplayPageFriendlyURLProvider;
	private final ColumnEntry _entry;
