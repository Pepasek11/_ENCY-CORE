 ...
 */
public class TableEntryAssetRenderer
        extends BaseJSPAssetRenderer<TableEntry> implements TrashRenderer {

    private static final Log _log = LogFactoryUtil.getLog(
            TableEntryAssetRenderer.class);

    public TableEntryAssetRenderer(
            TableEntry entry, ResourceBundleLoader resourceBundleLoader) {
    ...
    @Override
    public TableEntry getAssetObject() {
        return _entry;
    }
    ...
    public String getJspPath(HttpServletRequest request, String template) {
        if (template.equals(TEMPLATE_ABSTRACT) ||
            ...
            request.setAttribute("tableEntry", _entry);

            return "/table_entry/asset/" + template + ".jsp";
        }
...
//  //
    ...
    public String getType() {
        return TableEntryAssetRendererFactory.TYPE;
    }
...
/*
		...
		return getURLViewInContext(
			liferayPortletRequest, noSuchEntryRedirect, "/tableentry/crud",
...
*/
    ...
    public boolean hasEditPermission(PermissionChecker permissionChecker)
        ...
        return TableEntryEntryPermission.contains(
    ...
    private final TableEntry _entry;
