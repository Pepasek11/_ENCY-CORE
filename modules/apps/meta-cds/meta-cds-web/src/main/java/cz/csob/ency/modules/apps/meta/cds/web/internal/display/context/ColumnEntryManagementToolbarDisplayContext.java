...
import cz.csob.ency.modules.apps.meta.cds.web.internal.security.permission.resource.ColumnEntryPermission;
...
/**
 * ColumnEntry Management Toolbar Display Context
 *
 * @author Miroslav Čermák
 */
public class ColumnEntryManagementToolbarDisplayContext
        extends SearchContainerManagementToolbarDisplayContext {

    public ColumnEntryManagementToolbarDisplayContext(
...
//  //
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "columnType"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "columnType");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "columntype"));
                        });
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "columnName"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "columnName");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "columnname"));
                        });
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "columnFullName"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "columnFullName");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "columnfullname"));
                        });
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                ...
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "databaseName"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "databaseName");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "databasename"));
                        });

                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "dataType"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "dataType");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "datatype"));
                        });
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "dataSize"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "dataSize");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "datasize"));
                        });
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "isPrimaryKey"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "isPrimaryKey");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "isprimarykey"));
                        });
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
                                    Objects.equals(getOrderByCol(), "isNotNull"));
                            dropdownItem.setHref(
                                    _getCurrentSortingURL(), "orderByCol", "isNotNull");
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "isnotnull"));
                        });
                add(
                        dropdownItem -> {
                            dropdownItem.setActive(
...
//  //				
    ...
    public Map<String, Object> getComponentContext() throws PortalException {
        ...
        deleteEntriesURL.setParameter(
                ActionRequest.ACTION_NAME, "/columnentry/crud");
    ...
    public CreationMenu getCreationMenu() {
        if (!ColumnEntryPermission.contains(
        ...
        return new CreationMenu() {
            {
                addDropdownItem(
                        dropdownItem -> {
                            ...
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "add-columnentry"));
                        });
                addDropdownItem(
                        dropdownItem -> {
                            dropdownItem.setHref(
                                    ...
                                    "javax.portlet.action", "/columnentry/crud",
                                    "redirect", currentURLObj.toString());
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "import-columns"));
                        });
            }
        };
    }
    ...
    public String getSearchActionURL() {
        ...
        searchURL.setParameter("mvcRenderCommandName", "/columnentry/view");
    ...
    private PortletURL _getCurrentSortingURL() {
        ...
        String orderByCol = ParamUtil.getString(
                request, SearchContainer.DEFAULT_ORDER_BY_COL_PARAM, "columnEntryId");
        ...
        Map<String, String> advSearchKeywords = ColumnEntryViewHelper.getAdvSearchKeywords(liferayPortletRequest);
