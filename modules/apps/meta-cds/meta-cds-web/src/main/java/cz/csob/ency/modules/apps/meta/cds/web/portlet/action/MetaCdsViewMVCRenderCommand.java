...
public class MetaCdsViewMVCRenderCommand implements MVCRenderCommand {
    ...
    public String render(RenderRequest request, RenderResponse response) {
        ...
        switch (navigation) {
            case MetaCdsWebKeys.NAVIGATION_TABLES:
                doTables(request, response);
                break;
            case MetaCdsWebKeys.NAVIGATION_COLUMNS:
                doColumns(request, response);
                break;
            default:
                doSystems(request, response);
                break;
        }

        return MetaCdsWebKeys.VIEW_JSP;
    }

    private void doColumns(RenderRequest request, RenderResponse response) {
        request.setAttribute(
    ...
    private void doSystems(RenderRequest request, RenderResponse response) {
        request.setAttribute(
    ...
    private void doTables(RenderRequest request, RenderResponse response) {
        request.setAttribute(
