...
public class TableEntryAdminCrudMVCRenderCommand implements MVCRenderCommand {

    /**
     * Edit Page JSP file
     */
    public String getEditPageJSP() {
        return TableEntryWebKeys.ADMIN_EDIT_JSP;
    }
    ...
    public String getViewPageJSP() {
        return TableEntryWebKeys.ADMIN_VIEW_JSP;
    }
    ...
    public String getViewRecordPageJSP() {
        return TableEntryWebKeys.ADMIN_VIEW_RECORD_JSP;
    }
