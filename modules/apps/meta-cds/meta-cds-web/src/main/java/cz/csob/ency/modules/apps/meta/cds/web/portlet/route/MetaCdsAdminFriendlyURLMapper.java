...
@Component(
	property = {
		"com.liferay.portlet.friendly-url-routes=META-INF/friendly-url-routes/routes-admin.xml",
		"javax.portlet.name=" + MetaCdsPortletKeys.METACDS_ADMIN
	},
	service = FriendlyURLMapper.class
)
public class MetaCdsAdminFriendlyURLMapper extends DefaultFriendlyURLMapper {
	...
	private static final String _MAPPING = "metacdsadmin";
