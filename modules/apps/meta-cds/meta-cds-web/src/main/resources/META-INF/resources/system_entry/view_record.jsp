                ...
                <div class="flex-box">
                    ...
                    <div class="flex-item">
                        ...
                        <div class="flex-item">
                            ...
                            <div class="e3-ro-form-item"><%=systemEntry.getSystemType()%>
                            </div>
                        </div>
                        --%>
                    <div class="flex-item">
            ...
            columns: [
                {
                    ...
                    render: function (data, type, row) {
                        var url = '<%=viewTableUrl%>'.replace('%23pid%23',row.tableEntryId);
                ...
                {data: 'description'},
                {
                    ...
                    render: function (data, type) {
                        if (type === 'display') {
                            return '<a href="' + data + '" class="extlink" target="_blank"><liferay-ui:message key="dsa"/>&nbsp;<i class="icon-external-link"></i></a>';
                        }
                        return data;
                    }
                }
