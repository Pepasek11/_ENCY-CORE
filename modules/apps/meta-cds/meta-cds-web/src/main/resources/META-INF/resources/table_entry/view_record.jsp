            ...
            <liferay-ui:panel title="system-info" collapsible="false" iconCssClass="icon-info">
                ...
                <div class="flex-box ">
                    <div class="flex-item">
                        ...
                        <div>
                            <c:choose>
                                <c:when test="<%=tableEntry.getTableType().toLowerCase().equals("tt")%>">
                                    <clay:label label="table" displayType="info"/>
                                </c:when>
                                <c:when test="<%=tableEntry.getTableType().toLowerCase().equals("vw")%>">
                                    <clay:label label="view" displayType="info"/>
                                </c:when>
                                <c:otherwise>
                                    <clay:label label="<%=tableEntry.getTableType()%>" displayType="info"/>
                                </c:otherwise>
                            </c:choose>
                            <c:choose>
                                <c:when test="<%=tableEntry.isIsActive()%>">
...
<portlet:renderURL var="viewColumnUrl">
    ...
    <portlet:param name="<%= Constants.CMD %>" value="<%= Constants.VIEW %>"/>
    <portlet:param name="resourcePrimKey" value="#pid#"/>
</portlet:renderURL>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        var url = '<%=viewColumnUrl%>'.replace('%23pid%23',row.columnEntryId);
