...
/**
 * Provides the local service interface for PDRMapping. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Miroslav Čermák
 * @see PDRMappingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PDRMappingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>cz.csob.ency.pdr.service.impl.PDRMappingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pdr mapping local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PDRMappingLocalServiceUtil} if injection and service tracking are not available.
	 */
