...
/**
 * Provides the local service interface for ConnectionDefinition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConnectionDefinitionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ConnectionDefinitionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>cz.csob.ency.connection.service.impl.ConnectionDefinitionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the connection definition local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ConnectionDefinitionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ConnectionDefinition addConnectionDefinition(
	...
	public ConnectionDefinition createConnectionDefinition(long connectionId);
	...
	public ConnectionDefinition deleteConnectionDefinition(
		ConnectionDefinition connectionDefinition);

	public ConnectionDefinition deleteConnectionDefinition(Long id)
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ConnectionDefinition deleteConnectionDefinition(long connectionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ConnectionDefinition fetchConnectionDefinition(long connectionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ConnectionDefinition getConnectionDefinition(long connectionId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ConnectionDefinition updateConnectionDefinition(
		ConnectionDefinition connectionDefinition);
