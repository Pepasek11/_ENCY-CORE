 ...
 *
 */
public class JobNameComparator extends OrderByComparator<SchedulerJob> {
    ...
    public static final String[] ORDER_BY_FIELDS = {"jobName"};
    ...
    public JobNameComparator(boolean ascending) {
