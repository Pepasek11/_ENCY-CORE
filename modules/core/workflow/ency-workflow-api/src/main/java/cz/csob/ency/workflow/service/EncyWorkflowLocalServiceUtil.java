...
/**
 * Provides the local service utility for EncyWorkflow. This utility wraps
 * <code>cz.csob.ency.workflow.service.impl.EncyWorkflowLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EncyWorkflowLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>cz.csob.ency.workflow.service.impl.EncyWorkflowLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EncyWorkflow addEncyWorkflow(EncyWorkflow encyWorkflow) {
		return getService().addEncyWorkflow(encyWorkflow);
	}

	public static EncyWorkflow create() {
	 ...
	 */
	public static EncyWorkflow createEncyWorkflow(long workflowId) {
		return getService().createEncyWorkflow(workflowId);
	}
	 ...
	 * @return
	 */
	public static EncyWorkflow deactivateWorkflow(String definitionClass) {
		return getService().deactivateWorkflow(definitionClass);
	}
	 ...
	 */
	public static EncyWorkflow deleteEncyWorkflow(EncyWorkflow encyWorkflow) {
		return getService().deleteEncyWorkflow(encyWorkflow);
	}
	 ...
	 */
	public static EncyWorkflow deleteEncyWorkflow(long workflowId)
		throws PortalException {

		return getService().deleteEncyWorkflow(workflowId);
	}
	...
	public static EncyWorkflow fetchEncyWorkflow(long workflowId) {
		return getService().fetchEncyWorkflow(workflowId);
	}

	public static EncyWorkflow fetchEncyWorkflow(String className) {
		return getService().fetchEncyWorkflow(className);
	}
	 ...
	 * @throws PortalException if a ency workflow with the primary key could not be found
	 */
	public static EncyWorkflow getEncyWorkflow(long workflowId)
		throws PortalException {

		return getService().getEncyWorkflow(workflowId);
	}
	 ...
	 */
	public static List<EncyWorkflow> getEncyWorkflows(int start, int end) {
		return getService().getEncyWorkflows(start, end);
	}
	 ...
	 */
	public static int getEncyWorkflowsCount() {
		return getService().getEncyWorkflowsCount();
	}
	 ...
	 * @return
	 */
	public static EncyWorkflow saveWorkflow(
		cz.csob.ency.workflow.definition.EncyWorkflowDefinition definition) {

		return getService().saveWorkflow(definition);
	}
	 ...
	 */
	public static EncyWorkflow updateEncyWorkflow(EncyWorkflow encyWorkflow) {
		return getService().updateEncyWorkflow(encyWorkflow);
	}

	public static EncyWorkflowLocalService getService() {
		return _service;
	}

	private static volatile EncyWorkflowLocalService _service;
