...
/**
 * Provides the local service interface for EncyWorkflowState. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Miroslav Čermák
 * @see EncyWorkflowStateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EncyWorkflowStateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>cz.csob.ency.workflow.service.impl.EncyWorkflowStateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ency workflow state local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EncyWorkflowStateLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EncyWorkflowState addEncyWorkflowState(
	 ...
	 */
	@Transactional(enabled = false)
	public EncyWorkflowState createEncyWorkflowState(long stateId);
	...
	public EncyWorkflowState deleteEncyWorkflowState(
		EncyWorkflowState encyWorkflowState);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EncyWorkflowState deleteEncyWorkflowState(long stateId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EncyWorkflowState fetchEncyWorkflowState(long stateId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EncyWorkflowState getEncyWorkflowState(long stateId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EncyWorkflowState getEncyWorkflowState(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EncyWorkflowState> getEncyWorkflowStates(int start, int end);
	 ...
	 */
	@Transactional
	public EncyWorkflowState saveWorkflowState(
		EncyWorkflowStateDefinition definition, EncyWorkflow workflowEntry);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EncyWorkflowState updateEncyWorkflowState(
		EncyWorkflowState encyWorkflowState);
