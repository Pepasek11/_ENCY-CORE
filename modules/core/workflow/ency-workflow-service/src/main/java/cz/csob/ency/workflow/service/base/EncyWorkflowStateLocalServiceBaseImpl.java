...
/**
 * Provides the base implementation for the ency workflow state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cz.csob.ency.workflow.service.impl.EncyWorkflowStateLocalServiceImpl}.
 * </p>
 *
 * @author Miroslav Čermák
 * @see cz.csob.ency.workflow.service.impl.EncyWorkflowStateLocalServiceImpl
 * @generated
 */
public abstract class EncyWorkflowStateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EncyWorkflowStateLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EncyWorkflowStateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EncyWorkflowStateLocalServiceUtil</code>.
	 */
	...
	public EncyWorkflowState addEncyWorkflowState(
		...
		return encyWorkflowStatePersistence.update(encyWorkflowState);
	}
	...
	public EncyWorkflowState createEncyWorkflowState(long stateId) {
		return encyWorkflowStatePersistence.create(stateId);
	}
	...
	public EncyWorkflowState deleteEncyWorkflowState(long stateId)
		...
		return encyWorkflowStatePersistence.remove(stateId);
	}
	...
	public EncyWorkflowState deleteEncyWorkflowState(
		...
		return encyWorkflowStatePersistence.remove(encyWorkflowState);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return encyWorkflowStatePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EncyWorkflowState.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return encyWorkflowStatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return encyWorkflowStatePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return encyWorkflowStatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return encyWorkflowStatePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EncyWorkflowState fetchEncyWorkflowState(long stateId) {
		return encyWorkflowStatePersistence.fetchByPrimaryKey(stateId);
	}
	...
	public EncyWorkflowState getEncyWorkflowState(long stateId)
		...
		return encyWorkflowStatePersistence.findByPrimaryKey(stateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			encyWorkflowStateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EncyWorkflowState.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EncyWorkflowState.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return encyWorkflowStatePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return encyWorkflowStateLocalService.deleteEncyWorkflowState(
			(EncyWorkflowState)persistedModel);
	}

	@Override
	public BasePersistence<EncyWorkflowState> getBasePersistence() {
		return encyWorkflowStatePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return encyWorkflowStatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EncyWorkflowState> getEncyWorkflowStates(int start, int end) {
		return encyWorkflowStatePersistence.findAll(start, end);
	}
	...
	public int getEncyWorkflowStatesCount() {
		return encyWorkflowStatePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EncyWorkflowStateLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		encyWorkflowStateLocalService = (EncyWorkflowStateLocalService)aopProxy;

		_setLocalServiceUtilService(encyWorkflowStateLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EncyWorkflowStateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				encyWorkflowStatePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EncyWorkflowStateLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, encyWorkflowStateLocalService);
		}
