...
public class E3EntryModelResourcePermissionRegistrar {
    @Activate
    public void activate(BundleContext bundleContext) {
        Dictionary<String, Object> properties = new HashMapDictionary<>();

        properties.put("model.class.name", E3Entry.class.getName());

        _serviceRegistration = bundleContext.registerService(
                ModelResourcePermission.class,
                ModelResourcePermissionFactory.create(
                        E3Entry.class, E3Entry::getEntryId,
                     ...
                     /*
                        consumer.accept(
                                    new WorkflowedModelPermissionLogic<>(
                                            ...
                                            _groupLocalService, E3Entry::getEntryId));
    ...
    @Reference(target = "(resource.name=" + E3EntryConstants.RESOURCE_NAME + ")")
